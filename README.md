**DEPRECATED -- This repo is now part of [OpenLilyLib](https://github.com/openlilylib/snippets/tree/master/custom-music-fonts/smufl). All further updates will be there instead.**
